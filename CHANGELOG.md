...
- Skip Clojure tools installation when nothing runs: `--version`, `--help`, `-Sdescribe`, and `-Spath`, `-Stree` or `-P` with `-X` or `-T`.
...
- Catch up with Clojure CLI 1.12.5.1654

## 1.12.5.1645

- Catch up with Clojure CLI 1.12.5.1645

## 1.12.5.1638

- Catch up with Clojure CLI 1.12.5.1638
...
- Catch up with Clojure CLI 1.12.4.1597

## 1.12.4.1582

- Catch up with Clojure CLI 1.12.4.1582
...
- Catch up with Clojure CLI 1.12.2.1565
