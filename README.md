...
Can be run with [babashka](https://github.com/borkdude/babashka/) to improve startup time compared to running this script on the JVM. Note that this script is not faster than its original bash equivalent.
